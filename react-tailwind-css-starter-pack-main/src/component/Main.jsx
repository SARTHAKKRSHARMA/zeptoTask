  ...
  return (
    <div className='w-[60%] min-h-[500px] h-auto bg-[#DADADA] shadow-md rounded-md py-5 px-3'>
        <div onClick={clickHandler} className=' w-[100%] h-auto bg-[#EFEFEF]  flex flex-row gap-3 flex-wrap py-5 px-3 border-[#900C3F] border-b-4 rounded-md relative'>
            ...
            <div className=' w-auto max-w-[100%] min-w-[50%] h-auto bg-[#EFEFEF]  flex flex-row gap-3 flex-wrap rounded-md relative'>
                <input
                ...
                {
                    isVisible && <div ref={absoluteDivRef}  className='absolute min-w-[400px] w-auto max-w-[100%] h-auto bg-[#EFEFEF] left-0 top-[200%] py-1 overflow-x-auto'>
